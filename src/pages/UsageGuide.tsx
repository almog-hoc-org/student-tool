...
const mainSteps = [
  ...
  {
    icon: Home,
    title: 'בונים משכנתא מותאמת',
    text: 'אחרי שיש עסקה על השולחן, בונים את המימון סביבה. מכניסים סכום משכנתא, שנים וריביות במסלולים שונים, ורואים החזר חודשי משוער.',
    link: '/mortgage',
    action: 'פתח משכנתא',
  },
  {
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-2xl text-sm leading-7 text-muted-foreground sm:text-base">
                תחשוב על המערכת כמו מסלול קצר: קודם מבינים כמה כסף יש, אחר כך בוחנים עסקה
                אמיתית, בונים סביבה את המימון — ומשווים אותה לעסקאות אחרות.
              </p>
            </div>
          </div>
